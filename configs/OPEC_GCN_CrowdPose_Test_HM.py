...
data = dict(
    ...
    json_file=[dict(name='train_process_datasets/coco_pose_45.json', type="coco"),\
                   dict(name="./train_process_datasets/crowdpose_train_pair.json", type="crowd_pose")],
    img_dir={"crowd_pose": "./data/crowdpose/images", 'coco': "./data/coco/train2017"},
    black_list ={
    ...
    test=dict(
        type="PoseDatatest",
        json_file = dict(name="./test_process_datasets/crowdpose-test_gtbbox_12kpts_expandedbbox.json",type="crowd_pose"),
...
# log path
log_path = "CrowdPose_HM_TrueDGCN_Verify_withFlip_60epochs_bugfixed"
...
pred_json = "./test_process_datasets/crowdpose-test_gtbbox_12kpts_expandedbbox.json"
best_json ="./test_process_datasets/pred_test_best_match.json"
crowd_pose_dir = "./data/crowdpose/images"
lr_stone = [15,20]
